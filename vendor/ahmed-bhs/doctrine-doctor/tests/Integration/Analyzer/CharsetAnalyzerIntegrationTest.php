...
/**
 * Integration test for CharsetAnalyzer.
 *
 * Tests the analyzer's ability to detect issues and provide actionable suggestions.
 */
final class CharsetAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $charsetAnalyzer = $this->createAnalyzer();
        $issueCollection = $charsetAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issueCollection = $charsetAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $charsetAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): CharsetAnalyzer
    {
        ...
        return new CharsetAnalyzer($connection, $suggestionFactory);
    }
