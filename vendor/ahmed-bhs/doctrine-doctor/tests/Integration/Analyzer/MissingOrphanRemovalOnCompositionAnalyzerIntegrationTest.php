...
/**
 * Integration test for MissingOrphanRemovalOnCompositionAnalyzer.
 *
 * Tests the analyzer's ability to detect issues with entity metadata.
 */
final class MissingOrphanRemovalOnCompositionAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $missingOrphanRemovalOnCompositionAnalyzer = $this->createAnalyzer();
        $issueCollection = $missingOrphanRemovalOnCompositionAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issueCollection = $missingOrphanRemovalOnCompositionAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $missingOrphanRemovalOnCompositionAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): MissingOrphanRemovalOnCompositionAnalyzer
    {
