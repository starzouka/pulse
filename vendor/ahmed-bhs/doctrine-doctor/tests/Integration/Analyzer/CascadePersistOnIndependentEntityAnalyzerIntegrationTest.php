...
/**
 * Integration test for CascadePersistOnIndependentEntityAnalyzer.
 *
 * Tests the analyzer's ability to detect issues with entity metadata.
 */
final class CascadePersistOnIndependentEntityAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $cascadePersistOnIndependentEntityAnalyzer = $this->createAnalyzer();
        $issueCollection = $cascadePersistOnIndependentEntityAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issueCollection = $cascadePersistOnIndependentEntityAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $cascadePersistOnIndependentEntityAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): CascadePersistOnIndependentEntityAnalyzer
    {
