...
/**
 * Integration test for PrimaryKeyStrategyAnalyzer.
 *
 * Tests the analyzer's ability to detect issues and provide actionable suggestions.
 */
final class PrimaryKeyStrategyAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $primaryKeyStrategyAnalyzer = $this->createAnalyzer();
        $issueCollection = $primaryKeyStrategyAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issueCollection = $primaryKeyStrategyAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $primaryKeyStrategyAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): PrimaryKeyStrategyAnalyzer
    {
