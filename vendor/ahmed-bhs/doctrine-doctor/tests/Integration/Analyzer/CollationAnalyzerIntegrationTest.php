...
/**
 * Integration test for CollationAnalyzer.
 *
 * Tests the analyzer's ability to detect issues and provide actionable suggestions.
 */
final class CollationAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $collationAnalyzer = $this->createAnalyzer();
        $issueCollection = $collationAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issueCollection = $collationAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $collationAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): CollationAnalyzer
    {
        ...
        return new CollationAnalyzer($connection, $suggestionFactory);
    }
