...
/**
 * Integration test for EntityManagerInEntityAnalyzer.
 *
 * Tests the analyzer's ability to detect issues with entity metadata.
 */
final class EntityManagerInEntityAnalyzerIntegrationTest extends TestCase
{
    ...
    {
        $entityManagerInEntityAnalyzer = $this->createAnalyzer();
        $issues = $entityManagerInEntityAnalyzer->analyze(QueryDataCollection::empty());
    ...
    public function it_returns_consistent_results(): void
    {
        ...
        // Run analysis twice
        $issues1 = $entityManagerInEntityAnalyzer->analyze(QueryDataCollection::empty());
        $issues2 = $entityManagerInEntityAnalyzer->analyze(QueryDataCollection::empty());
    ...
    private function createAnalyzer(): EntityManagerInEntityAnalyzer
    {
