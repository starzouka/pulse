...
/**
 * Test for StrictModeAnalyzer.
 *
 * This analyzer detects database strict mode configuration issues.
 *
 * Note: Full integration tests exist in StrictModeAnalyzerIntegrationTest.
 * These unit tests verify basic analyzer behavior and metadata.
 */
final class StrictModeAnalyzerTest extends TestCase
{
    private StrictModeAnalyzer $analyzer;

    protected function setUp(): void
    {
        $connection = PlatformAnalyzerTestHelper::createTestConnection();

        $this->analyzer = new StrictModeAnalyzer(
            $connection,
