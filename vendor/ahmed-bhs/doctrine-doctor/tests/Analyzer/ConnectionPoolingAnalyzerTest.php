...
/**
 * Test for ConnectionPoolingAnalyzer.
 *
 * This analyzer detects database connection pooling configuration issues.
 *
 * Note: Full integration tests exist in ConnectionPoolingAnalyzerIntegrationTest.
 * These unit tests verify basic analyzer behavior and metadata.
 */
final class ConnectionPoolingAnalyzerTest extends TestCase
{
    private ConnectionPoolingAnalyzer $analyzer;

    protected function setUp(): void
    {
        $connection = PlatformAnalyzerTestHelper::createTestConnection();

        $this->analyzer = new ConnectionPoolingAnalyzer(
            $connection,
