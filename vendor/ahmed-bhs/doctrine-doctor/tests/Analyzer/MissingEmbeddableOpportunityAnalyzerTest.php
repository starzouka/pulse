...
/**
 * Test for MissingEmbeddableOpportunityAnalyzer.
 *
 * This analyzer detects entities with scattered fields that should be embeddables.
 *
 ...
 *
 * Full integration tests exist in MissingEmbeddableOpportunityAnalyzerIntegrationTest.
 * These unit tests verify basic analyzer behavior and metadata.
 */
final class MissingEmbeddableOpportunityAnalyzerTest extends TestCase
{
    private MissingEmbeddableOpportunityAnalyzer $analyzer;

    protected function setUp(): void
    {
        $entityManager = PlatformAnalyzerTestHelper::createTestEntityManager();

        $this->analyzer = new MissingEmbeddableOpportunityAnalyzer(
            $entityManager,
