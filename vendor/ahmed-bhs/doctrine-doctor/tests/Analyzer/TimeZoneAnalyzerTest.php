...
/**
 * Test for TimeZoneAnalyzer.
 *
 * This analyzer detects database time zone configuration issues.
 *
 * Note: Full integration tests exist in TimeZoneAnalyzerIntegrationTest.
 * These unit tests verify basic analyzer behavior and metadata.
 */
final class TimeZoneAnalyzerTest extends TestCase
{
    private TimeZoneAnalyzer $analyzer;

    protected function setUp(): void
    {
        $connection = PlatformAnalyzerTestHelper::createTestConnection();

        $this->analyzer = new TimeZoneAnalyzer(
            $connection,
