 ...
 */
class getTwigService extends App_KernelLintContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $f = new \CMEN\GoogleChartsBundle\Output\Javascript\DateOutput();
        $g = new \Symfony\Bridge\Twig\AppVariable();
        $g->setEnvironment('lint');
        $g->setDebug(false);
        $g->setTokenStorage($e);
        ...
        $instance->addExtension(new \App\Twig\UserContextExtension(new \App\Security\CaptainAccess(($container->privates['App\\Repository\\TeamRepository'] ?? $container->load('getTeamRepositoryService')))));
