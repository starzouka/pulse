 ...
 */
class getRouting_LoaderService extends App_KernelLintContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('lint');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'lint'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'lint'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'lint'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'lint'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'lint'));
