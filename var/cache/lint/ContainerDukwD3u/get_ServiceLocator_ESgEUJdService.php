 ...
 */
class get_ServiceLocator_ESgEUJdService extends App_KernelLintContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.ESgEUJd'])) {
            return $container->privates['.service_locator.ESgEUJd'];
        }

        return $container->privates['.service_locator.ESgEUJd'] = $instance;
    }
}
