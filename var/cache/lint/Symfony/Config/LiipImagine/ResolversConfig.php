...
class ResolversConfig 
{
     ...
     * @param TValue $value
     * @return \Symfony\Config\LiipImagine\ResolversConfig\AwsS3Config|$this
     * @psalm-return (TValue is array ? \Symfony\Config\LiipImagine\ResolversConfig\AwsS3Config : static)
     */
    public function awsS3(mixed $value = []): \Symfony\Config\LiipImagine\ResolversConfig\AwsS3Config|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->awsS3 instanceof \Symfony\Config\LiipImagine\ResolversConfig\AwsS3Config) {
            $this->_usedProperties['awsS3'] = true;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('aws_s3', $value)) {
            $this->_usedProperties['awsS3'] = true;
            $this->awsS3 = \is_array($value['aws_s3']) ? new \Symfony\Config\LiipImagine\ResolversConfig\AwsS3Config($value['aws_s3']) : $value['aws_s3'];
            unset($value['aws_s3']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['awsS3'])) {
            $output['aws_s3'] = $this->awsS3 instanceof \Symfony\Config\LiipImagine\ResolversConfig\AwsS3Config ? $this->awsS3->toArray() : $this->awsS3;
        }
