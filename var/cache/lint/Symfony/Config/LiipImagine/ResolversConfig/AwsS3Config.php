...
class AwsS3Config 
{
     ...
     * @return $this
     */
    public function usePsrCache($value): static
    {
        $this->_usedProperties['usePsrCache'] = true;
        $this->usePsrCache = $value;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('use_psr_cache', $value)) {
            $this->_usedProperties['usePsrCache'] = true;
            $this->usePsrCache = $value['use_psr_cache'];
            unset($value['use_psr_cache']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['usePsrCache'])) {
            $output['use_psr_cache'] = $this->usePsrCache;
        }
