...
require_once __DIR__.\DIRECTORY_SEPARATOR.'LoadersConfig'.\DIRECTORY_SEPARATOR.'AssetMapperConfig.php';
...
class LoadersConfig 
{
    ...
    public function assetMapper(array $value = []): \Symfony\Config\LiipImagine\LoadersConfig\AssetMapperConfig
    {
        if (null === $this->assetMapper) {
            $this->_usedProperties['assetMapper'] = true;
            $this->assetMapper = new \Symfony\Config\LiipImagine\LoadersConfig\AssetMapperConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('asset_mapper', $value)) {
            $this->_usedProperties['assetMapper'] = true;
            $this->assetMapper = new \Symfony\Config\LiipImagine\LoadersConfig\AssetMapperConfig($value['asset_mapper']);
