 ...
 */
class getTournamentMatchRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TournamentMatchRepository' shared autowired service.
     *
     * @return \App\Repository\TournamentMatchRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TournamentMatchRepository.php';

        return $container->privates['App\\Repository\\TournamentMatchRepository'] = new \App\Repository\TournamentMatchRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
