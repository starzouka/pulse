 ...
 */
class getTournamentTeamRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TournamentTeamRepository' shared autowired service.
     *
     * @return \App\Repository\TournamentTeamRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TournamentTeamRepository.php';

        return $container->privates['App\\Repository\\TournamentTeamRepository'] = new \App\Repository\TournamentTeamRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
