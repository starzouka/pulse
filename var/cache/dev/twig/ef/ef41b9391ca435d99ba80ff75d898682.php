...
class __TwigTemplate_aa2ed6efa238da9b1d9d585cc0ee7c26 extends Template
{
  ...
  <section class=\"panel\">
    ...
    ";
      ...
      ";
        // line 45
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["messageForm"]) || array_key_exists("messageForm", $context) ? $context["messageForm"] : (function () { throw new RuntimeError('Variable "messageForm" does not exist.', 45, $this->source); })()), 'errors');
        yield "
      ";
        // line 46
        yield from $this->load("admin/pages/_message_form_fields.html.twig", 46)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["messageForm"]) || array_key_exists("messageForm", $context) ? $context["messageForm"] : (function () { throw new RuntimeError('Variable "messageForm" does not exist.', 46, $this->source); })())]));
        // line 47
        yield "      <div class=\"formActions\" style=\"margin-top:12px;\">
        <button class=\"btn btnPrimary\" type=\"submit\">";
        // line 48
        yield (((($tmp = (isset($context["editingMessage"]) || array_key_exists("editingMessage", $context) ? $context["editingMessage"] : (function () { throw new RuntimeError('Variable "editingMessage" does not exist.', 48, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Mettre a jour") : ("Creer message"));
        yield "</button>
        ";
        // line 49
        if ((($tmp = (isset($context["editingMessage"]) || array_key_exists("editingMessage", $context) ? $context["editingMessage"] : (function () { throw new RuntimeError('Variable "editingMessage" does not exist.', 49, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 50
    ...
    ";
        // line 53
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["messageForm"]) || array_key_exists("messageForm", $context) ? $context["messageForm"] : (function () { throw new RuntimeError('Variable "messageForm" does not exist.', 53, $this->source); })()), 'form_end');
        yield "
  </section>
  ...
  <form class=\"filtersBar\" method=\"get\" action=\"";
    ...
    <div class=\"filterGroup\">
      ...
      <input type=\"search\" name=\"sender\" value=\"";
        // line 66
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 66, $this->source); })()), "sender", [], "any", false, false, false, 66), "html", null, true);
    ...
    <div class=\"filterGroup\">
      ...
      <input type=\"search\" name=\"receiver\" value=\"";
        // line 71
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 71, $this->source); })()), "receiver", [], "any", false, false, false, 71), "html", null, true);
        yield "\" placeholder=\"username/email\" />
    </div>
    ...
    <div class=\"filterGroup\">
      ...
      <select name=\"is_read\">
        <option value=\"\" ";
        // line 77
        yield (((CoreExtension::getAttribute($this->env, $this->source, (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 77, $this->source); })()), "is_read", [], "any", false, false, false, 77) == "")) ? ("selected") : (""));
        yield ">ALL</option>
        <option value=\"0\" ";
        // line 78
        yield (((CoreExtension::getAttribute($this->env, $this->source, (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 78, $this->source); })()), "is_read", [], "any", false, false, false, 78) == "0")) ? ("selected") : (""));
        yield ">Non</option>
        <option value=\"1\" ";
        // line 79
        yield (((CoreExtension::getAttribute($this->env, $this->source, (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 79, $this->source); })()), "is_read", [], "any", false, false, false, 79) == "1")) ? ("selected") : (""));
        yield ">Oui</option>
      </select>
    </div>
      ...
      <table class=\"dataTable\">
        <thead>
          <tr>
            <th>";
        // line 99
        yield $macros["sorter"]->getTemplateForMacro("macro_sort_link", $context, 99, $this->getSourceContext())->macro_sort_link(...["admin_messages", (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 99, $this->source); })()), "id", "ID"]);
        yield "</th>
            <th>";
        // line 100
        yield $macros["sorter"]->getTemplateForMacro("macro_sort_link", $context, 100, $this->getSourceContext())->macro_sort_link(...["admin_messages", (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 100, $this->source); })()), "sender", "Sender"]);
        yield "</th>
            <th>";
        // line 101
        yield $macros["sorter"]->getTemplateForMacro("macro_sort_link", $context, 101, $this->getSourceContext())->macro_sort_link(...["admin_messages", (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 101, $this->source); })()), "receiver", "Receiver"]);
        yield "</th>
            <th>";
        // line 102
        yield $macros["sorter"]->getTemplateForMacro("macro_sort_link", $context, 102, $this->getSourceContext())->macro_sort_link(...["admin_messages", (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 102, $this->source); })()), "content", "Extrait"]);
        yield "</th>
            <th>";
        // line 103
        yield $macros["sorter"]->getTemplateForMacro("macro_sort_link", $context, 103, $this->getSourceContext())->macro_sort_link(...["admin_messages", (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 103, $this->source); })()), "created_at", "Created"]);
        yield "</th>
            <th>";
        // line 104
        yield $macros["sorter"]->getTemplateForMacro("macro_sort_link", $context, 104, $this->getSourceContext())->macro_sort_link(...["admin_messages", (isset($context["filters"]) || array_key_exists("filters", $context) ? $context["filters"] : (function () { throw new RuntimeError('Variable "filters" does not exist.', 104, $this->source); })()), "is_read", "Read"]);
        yield "</th>
            <th>Actions</th>
          </tr>
        </thead>
        ...
        // line 109
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 109, $this->source); })()));
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 110
            yield "            ";
            $context["messageId"] = (((CoreExtension::getAttribute($this->env, $this->source, $context["message"], "messageId", [], "any", true, true, false, 110) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["message"], "messageId", [], "any", false, false, false, 110)))) ? (CoreExtension::getAttribute($this->env, $this->source, $context["message"], "messageId", [], "any", false, false, false, 110)) : (0));
            // line 111
            yield "            <tr>
              <td>#";
            // line 112
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["messageId"]) || array_key_exists("messageId", $context) ? $context["messageId"] : (function () { throw new RuntimeError('Variable "messageId" does not exist.', 112, $this->source); })()), "html", null, true);
            yield "</td>
              <td>";
            // line 113
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["message"], "senderUserId", [], "any", false, false, false, 113)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["message"], "senderUserId", [], "any", false, false, false, 113), "username", [], "any", false, false, false, 113), "html", null, true)) : ("-"));
            yield "</td>
              <td>";
            // line 114
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["message"], "receiverUserId", [], "any", false, false, false, 114)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["message"], "receiverUserId", [], "any", false, false, false, 114), "username", [], "any", false, false, false, 114), "html", null, true)) : ("-"));
            yield "</td>
              <td>";
            // line 115
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["message"], "bodyText", [], "any", false, false, false, 115)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["message"], "bodyText", [], "any", false, false, false, 115), 0, 90), "html", null, true)) : ("-"));
            yield "</td>
              <td>";
            // line 116
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["message"], "createdAt", [], "any", false, false, false, 116)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["message"], "createdAt", [], "any", false, false, false, 116), "d/m/Y H:i"), "html", null, true)) : ("-"));
            yield "</td>
              <td>";
            // line 117
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["message"], "isRead", [], "any", false, false, false, 117)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Oui") : ("Non"));
            yield "</td>
              <td>
                <div class=\"formActions\">
                  <a class=\"btn btnTiny\" href=\"";
            // line 120
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_messages", ["edit" => (isset($context["messageId"]) || array_key_exists("messageId", $context) ? $context["messageId"] : (function () { throw new RuntimeError('Variable "messageId" does not exist.', 120, $this->source); })())]), "html", null, true);
            yield "\">Update</a>
                  <form method=\"post\" action=\"";
            // line 121
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_message_delete", ["id" => (isset($context["messageId"]) || array_key_exists("messageId", $context) ? $context["messageId"] : (function () { throw new RuntimeError('Variable "messageId" does not exist.', 121, $this->source); })())]), "html", null, true);
            yield "\" onsubmit=\"return confirm('Supprimer ce message ?');\" style=\"display:inline-block;\">
                    <input type=\"hidden\" name=\"_token\" value=\"";
            // line 122
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete_message_" . (isset($context["messageId"]) || array_key_exists("messageId", $context) ? $context["messageId"] : (function () { throw new RuntimeError('Variable "messageId" does not exist.', 122, $this->source); })()))), "html", null, true);
            yield "\" />
...
";
    ...
    {
        return array (  427 => 10,  422 => 9,  419 => 8,  416 => 7,  413 => 6,  410 => 5,  407 => 4,  386 => 3,  371 => 133,  362 => 129,  360 => 128,  349 => 122,  345 => 121,  341 => 120,  335 => 117,  331 => 116,  327 => 115,  323 => 114,  319 => 113,  315 => 112,  312 => 111,  309 => 110,  304 => 109,  296 => 104,  292 => 103,  288 => 102,  284 => 101,  280 => 100,  276 => 99,  266 => 92,  256 => 85,  247 => 79,  243 => 78,  239 => 77,  230 => 71,  222 => 66,  214 => 61,  208 => 58,  204 => 57,  200 => 56,  194 => 53,  191 => 52,  185 => 50,  183 => 49,  179 => 48,  176 => 47,  174 => 46,  170 => 45,  166 => 44,  160 => 41,  155 => 38,  149 => 37,  138 => 34,  134 => 33,  131 => 32,  126 => 31,  122 => 30,  115 => 26,  111 => 25,  103 => 19,  90 => 18,  67 => 16,  56 => 1,  54 => 14,  41 => 1,);
    }
...
{% endblock %}
", "admin/pages/messages.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE - Copie\\PULSE\\templates\\admin\\pages\\messages.html.twig");
    }
}
