...
class __TwigTemplate_55cb76d8bef19d3f154debc1fa88ee08 extends Template
{
...
($context["hero_stats"] ?? null), "players", [], "any", true, true, false, 13)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["hero_stats"]) || array_key_exists("hero_stats", $context) ? $context["hero_stats"] : (function () { throw new RuntimeError('Variable "hero_stats" does not exist.', 13, $this->source); })()), "players", [], "any", false, false, false, 13), 0)) : (0))]));
  ...
  <main class=\"page\">
    <section class=\"belowHero\">
              ...
              <article class=\"card card--game\">
                ...
                yield "</b></p>
                  <div class=\"card__actions\">
                    <a class=\"btn btn--ghost\" href=\"";
                // line 231
                yield ((((isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 231, $this->source); })()) > 0)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_game_detail", ["slug" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["game"]) || array_key_exists("game", $context) ? $context["game"] : (function () { throw new RuntimeError('Variable "game" does not exist.', 231, $this->source); })()), "slug", [], "any", false, false, false, 231)]), "html", null, true)) : ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_games")));
                yield "\">Detail</a>
                  </div>
                </div>
              </article>
        ...
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["home_team_cards"]) || array_key_exists("home_team_cards", $context) ? $context["home_team_cards"] : (function () { throw new RuntimeError('Variable "home_team_cards" does not exist.', 254, $this->source); })()))) {
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                ...
                // line 261
                yield "              ";
                if (((isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 261, $this->source); })()) && (is_string($_v6 = (isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 261, $this->source); })())) && is_string($_v7 = "http") && str_starts_with($_v6, $_v7)))) {
                    // line 262
                    yield "                ";
                    $context["logoUrl"] = (isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 262, $this->source); })());
                    // line 263
                    yield "              ";
                } elseif ((($tmp = (isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 263, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 264
                    yield "                ";
                    $context["logoUrl"] = $this->extensions['Liip\ImagineBundle\Templating\FilterExtension']->filter($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 264, $this->source); })())), "team_banner");
                    // line 265
                    yield "              ";
                } else {
                    // line 266
                    yield "                ";
                    $context["logoUrl"] = (("https://picsum.photos/seed/pulse_home_team_" . (isset($context["teamId"]) || array_key_exists("teamId", $context) ? $context["teamId"] : (function () { throw new RuntimeError('Variable "teamId" does not exist.', 266, $this->source); })())) . "/1200/800");
                    // line 267
                    yield "              ";
                }
                // line 268
                yield "              ";
                $context["captain"] = CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 268, $this->source); })()), "captainUserId", [], "any", false, false, false, 268);
                // line 269
                yield "
              <article class=\"card card--team\">
                <div class=\"card__media\" data-bg=\"";
                // line 271
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["logoUrl"]) || array_key_exists("logoUrl", $context) ? $context["logoUrl"] : (function () { throw new RuntimeError('Variable "logoUrl" does not exist.', 271, $this->source); })()), "html", null, true);
                yield "\">
                  <div class=\"card__chips\">
                    <span class=\"chip chip--region\">";
                // line 273
                yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 273, $this->source); })()), "region", [], "any", false, false, false, 273)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 273, $this->source); })()), "region", [], "any", false, false, false, 273), "html", null, true)) : ("Region -"));
                yield "</span>
                    <span class=\"chip\">Membres: ";
                // line 274
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "members_count", [], "any", false, false, false, 274), "html", null, true);
                yield "</span>
                    <span class=\"chip\">Tournois actifs: ";
                // line 275
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "active_tournaments_count", [], "any", false, false, false, 275), "html", null, true);
                yield "</span>
                  </div>
                </div>
                ...
                <div class=\"card__body\">
                  <h4 class=\"card__title\">";
                // line 280
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 280, $this->source); })()), "name", [], "any", false, false, false, 280), "html", null, true);
                yield "</h4>
                  <p class=\"card__desc\">Capitaine: <b>";
                // line 281
                yield (((($tmp = (isset($context["captain"]) || array_key_exists("captain", $context) ? $context["captain"] : (function () { throw new RuntimeError('Variable "captain" does not exist.', 281, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (((CoreExtension::getAttribute($this->env, $this->source, (isset($context["captain"]) || array_key_exists("captain", $context) ? $context["captain"] : (function () { throw new RuntimeError('Variable "captain" does not exist.', 281, $this->source); })()), "displayName", [], "any", false, false, false, 281)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["captain"]) || array_key_exists("captain", $context) ? $context["captain"] : (function () { throw new RuntimeError('Variable "captain" does not exist.', 281, $this->source); })()), "displayName", [], "any", false, false, false, 281), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["captain"]) || array_key_exists("captain", $context) ? $context["captain"] : (function () { throw new RuntimeError('Variable "captain" does not exist.', 281, $this->source); })()), "username", [], "any", false, false, false, 281), "html", null, true)))) : ("-"));
                yield "</b> | Produits: <b>";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "products_count", [], "any", false, false, false, 281), "html", null, true);
                yield "</b></p>
                  <div class=\"card__actions\">
                    <a class=\"btn btn--ghost\" href=\"";
                // line 283
                yield ((((isset($context["teamId"]) || array_key_exists("teamId", $context) ? $context["teamId"] : (function () { throw new RuntimeError('Variable "teamId" does not exist.', 283, $this->source); })()) > 0)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_team_detail", ["id" => (isset($context["teamId"]) || array_key_exists("teamId", $context) ? $context["teamId"] : (function () { throw new RuntimeError('Variable "teamId" does not exist.', 283, $this->source); })())]), "html", null, true)) : ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_teams")));
                yield "\">Detail</a>
                  </div>
                </div>
              </article>
      ...
      ";
        // line 308
        yield from $this->load("front/partials/_footer.html.twig", 308)->unwrap()->yield($context);
        // line 309
        yield "    </section>
  </main>
  ...
  ";
        // line 312
        yield from $this->load("front/partials/_auth_modal.html.twig", 312)->unwrap()->yield($context);
    ...
    {
        return array (  656 => 312,  651 => 309,  649 => 308,  628 => 289,  625 => 288,  614 => 283,  607 => 281,  603 => 280,  595 => 275,  591 => 274,  587 => 273,  582 => 271,  578 => 269,  575 => 268,  572 => 267,  569 => 266,  566 => 265,  563 => 264,  560 => 263,  557 => 262,  554 => 261,  551 => 260,  548 => 259,  545 => 258,  540 => 257,  536 => 255,  534 => 254,  526 => 249,  512 => 237,  509 => 236,  498 => 231,  491 => 229,  487 => 228,  479 => 223,  475 => 222,  471 => 221,  466 => 219,  462 => 217,  459 => 216,  456 => 215,  453 => 214,  450 => 213,  445 => 212,  441 => 210,  439 => 209,  431 => 204,  417 => 192,  414 => 191,  403 => 186,  398 => 184,  394 => 183,  386 => 178,  382 => 177,  378 => 176,  373 => 174,  369 => 172,  366 => 171,  363 => 170,  360 => 169,  357 => 168,  352 => 167,  348 => 165,  346 => 164,  338 => 159,  308 => 131,  305 => 130,  296 => 126,  290 => 124,  284 => 122,  282 => 121,  275 => 117,  266 => 113,  262 => 112,  258 => 111,  251 => 107,  247 => 106,  242 => 104,  234 => 99,  230 => 98,  226 => 97,  221 => 95,  217 => 93,  214 => 92,  211 => 91,  208 => 90,  205 => 89,  202 => 88,  199 => 87,  194 => 86,  190 => 84,  188 => 83,  180 => 78,  173 => 73,  165 => 71,  163 => 70,  106 => 15,  104 => 13,  103 => 12,  102 => 11,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
            ...
            {% for row in home_game_cards %}
              ...
              <article class=\"card card--game\">
                ...
                <div class=\"card__body\">
                  ...
                  <div class=\"card__actions\">
                    <a class=\"btn btn--ghost\" href=\"{{ gameId > 0 ? path('front_game_detail', {slug: game.slug}) : path('front_games') }}\">Detail</a>
                  </div>
                </div>
              </article>
            {% endfor %}
        ...
        <div class=\"cardsGrid cardsGrid--teams cardsScroller hide-scrollbar overflow-x-scroll\" id=\"topTeamsGrid\" data-server-rendered=\"1\">
          ...
          {% else %}
            {% for row in home_team_cards %}
              ...
              {% elseif logoPath %}
                {% set logoUrl = asset(logoPath)|imagine_filter('team_banner') %}
              {% else %}
                {% set logoUrl = 'https://picsum.photos/seed/pulse_home_team_' ~ teamId ~ '/1200/800' %}
              {% endif %}
...
{% endblock %}
", "front/home/index.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE - Copie\\PULSE\\templates\\front\\home\\index.html.twig");
    }
}
