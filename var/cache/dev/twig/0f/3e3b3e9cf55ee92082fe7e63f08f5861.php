...
class __TwigTemplate_5931c8f37024e57c93fa5566bbce4b6b extends Template
{
...
(isset($context["registration_open"]) || array_key_exists("registration_open", $context) ? $context["registration_open"] : (function () { throw new RuntimeError('Variable "registration_open" does not exist.', 63, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
      ...
      <section class=\"panel\">
        ...
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["participants"]) || array_key_exists("participants", $context) ? $context["participants"] : (function () { throw new RuntimeError('Variable "participants" does not exist.', 219, $this->source); })()))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["participant"]) {
                ...
                // line 227
                yield "                  ";
                if (((isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 227, $this->source); })()) && (is_string($_v2 = (isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 227, $this->source); })())) && is_string($_v3 = "http") && str_starts_with($_v2, $_v3)))) {
                    // line 228
                    yield "                    ";
                    $context["logoUrl"] = (isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 228, $this->source); })());
                    // line 229
                    yield "                  ";
                } elseif ((($tmp = (isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 229, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 230
                    yield "                    ";
                    $context["logoUrl"] = $this->extensions['Liip\ImagineBundle\Templating\FilterExtension']->filter($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((isset($context["logoPath"]) || array_key_exists("logoPath", $context) ? $context["logoPath"] : (function () { throw new RuntimeError('Variable "logoPath" does not exist.', 230, $this->source); })())), "team_banner");
                    // line 231
                    yield "                  ";
                } else {
                    // line 232
                    yield "                    ";
                    $context["logoUrl"] = (("https://picsum.photos/seed/pulse_team_detail_" . (isset($context["teamId"]) || array_key_exists("teamId", $context) ? $context["teamId"] : (function () { throw new RuntimeError('Variable "teamId" does not exist.', 232, $this->source); })())) . "/800/600");
                    // line 233
                    yield "                  ";
                }
                // line 234
                ...
                // line 235
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["logoUrl"]) || array_key_exists("logoUrl", $context) ? $context["logoUrl"] : (function () { throw new RuntimeError('Variable "logoUrl" does not exist.', 235, $this->source); })()), "html", null, true);
                yield "\">
                      <div class=\"card__chips\">
                        <span class=\"chip\">";
                // line 237
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["participant"], "status", [], "any", false, false, false, 237), "html", null, true);
                yield "</span>
                        <span class=\"chip\">Inscrit le ";
                // line 238
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["participant"], "registeredAt", [], "any", false, false, false, 238)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["participant"], "registeredAt", [], "any", false, false, false, 238), "d/m/Y"), "html", null, true)) : ("-"));
                yield "</span>
                      </div>
                    </div>
                    <div class=\"card__body\">
                      <h4 class=\"card__title\">";
                // line 242
                yield (((($tmp = (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 242, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 242, $this->source); })()), "name", [], "any", false, false, false, 242), "html", null, true)) : ("Equipe"));
                yield "</h4>
                      <p class=\"card__desc\">";
                // line 243
                yield ((((isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 243, $this->source); })()) && CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 243, $this->source); })()), "region", [], "any", false, false, false, 243))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["team"]) || array_key_exists("team", $context) ? $context["team"] : (function () { throw new RuntimeError('Variable "team" does not exist.', 243, $this->source); })()), "region", [], "any", false, false, false, 243), "html", null, true)) : ("Region non renseignee"));
                yield "</p>
                      <div class=\"card__actions\">
                        <a class=\"btn btn--ghost\" href=\"";
                // line 245
      ...
      ";
        // line 256
        yield from $this->load("front/partials/_footer.html.twig", 256)->unwrap()->yield($context);
        // line 257
        yield "    </section>
  </main>
  ...
  ";
        // line 260
        yield from $this->load("front/partials/_auth_modal.html.twig", 260)->unwrap()->yield($context);
            ...
            {% else %}
              <div class=\"cardsGrid\">
                {% for participant in participants %}
                  ...
                  {% else %}
                    {% set logoUrl = 'https://picsum.photos/seed/pulse_team_detail_' ~ teamId ~ '/800/600' %}
                  {% endif %}
...
{% endblock %}
", "front/pages/tournament-detail.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE - Copie\\PULSE\\templates\\front\\pages\\tournament-detail.html.twig");
    }
}
