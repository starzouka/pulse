...
class __TwigTemplate_6499ede97dfdae2064a677620f9732bf extends Template
{
    ...
    <section class=\"belowHero\">
      <div class=\"layout\">
        ...
        yield "
              ";
        // line 37
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["matchForm"]) || array_key_exists("matchForm", $context) ? $context["matchForm"] : (function () { throw new RuntimeError('Variable "matchForm" does not exist.', 37, $this->source); })()), 'errors');
        yield "
              ";
        // line 38
        yield from $this->load("shared/_organizer_match_form_fields.html.twig", 38)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["matchForm"]) || array_key_exists("matchForm", $context) ? $context["matchForm"] : (function () { throw new RuntimeError('Variable "matchForm" does not exist.', 38, $this->source); })())]));
        // line 39
        yield "
        ...
        // line 54
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["participantRows"]) || array_key_exists("participantRows", $context) ? $context["participantRows"] : (function () { throw new RuntimeError('Variable "participantRows" does not exist.', 54, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            yield "                      <tr>
                        <td>";
            // line 56
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "team", [], "any", false, false, false, 56), "name", [], "any", false, false, false, 56), "html", null, true);
            yield "</td>
                        <td>
                          <input
                            class=\"input\"
                            ...
                            name=\"team_scores[";
            // line 62
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "team", [], "any", false, false, false, 62), "teamId", [], "any", false, false, false, 62), "html", null, true);
            yield "]\"
                            value=\"";
            // line 63
            yield (((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["row"], "score", [], "any", false, false, false, 63))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["row"], "score", [], "any", false, false, false, 63), "html", null, true)) : (""));
            yield "\"
                          />
                        </td>
                        <td>
            ...
            // line 68
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "team", [], "any", false, false, false, 68), "teamId", [], "any", false, false, false, 68), "html", null, true);
            yield "\" ";
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["row"], "isWinner", [], "any", false, false, false, 68)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("checked") : (""));
            yield " />
        ...
        // line 84
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_organizer_matches", (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["tournamentMatch"]) || array_key_exists("tournamentMatch", $context) ? $context["tournamentMatch"] : (function () { throw new RuntimeError('Variable "tournamentMatch" does not exist.', 84, $this->source); })()), "tournamentId", [], "any", false, false, false, 84)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (["tournament" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["tournamentMatch"]) || array_key_exists("tournamentMatch", $context) ? $context["tournamentMatch"] : (function () { throw new RuntimeError('Variable "tournamentMatch" does not exist.', 84, $this->source); })()), "tournamentId", [], "any", false, false, false, 84), "tournamentId", [], "any", false, false, false, 84)]) : ([]))), "html", null, true);
        yield "\">Retour</a>
              </div>
            ";
        // line 86
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["matchForm"]) || array_key_exists("matchForm", $context) ? $context["matchForm"] : (function () { throw new RuntimeError('Variable "matchForm" does not exist.', 86, $this->source); })()), 'form_end');
        yield "
          </section>
      ...
      ";
        // line 110
        yield from $this->load("front/partials/_footer.html.twig", 110)->unwrap()->yield($context);
        // line 111
        yield "    </section>
  </main>
  ...
  ";
        // line 114
        yield from $this->load("front/partials/_auth_modal.html.twig", 114)->unwrap()->yield($context);
    ...
    {
        return array (  291 => 114,  286 => 111,  284 => 110,  257 => 86,  252 => 84,  244 => 78,  235 => 74,  233 => 73,  221 => 68,  213 => 63,  209 => 62,  200 => 56,  197 => 55,  192 => 54,  175 => 39,  173 => 38,  169 => 37,  165 => 36,  158 => 32,  154 => 31,  148 => 27,  142 => 26,  131 => 23,  127 => 22,  124 => 21,  119 => 20,  115 => 19,  111 => 17,  109 => 16,  103 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "front/pages/organizer-match-edit.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE - Copie\\PULSE\\templates\\front\\pages\\organizer-match-edit.html.twig");
    }
}
