...
class __TwigTemplate_24490b79c3aa7773e671614c77087d2d extends Template
{
...
<aside class=\"sidebar\">
  ...
  <nav class=\"sideNav\" aria-label=\"Navigation principale\">
    ...
    <a class=\"navItem ";
        // line 55
        yield ((((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 55, $this->source); })()) == "admin_catalog_dashboard")) ? ("active") : (""));
        yield "\" href=\"";
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_catalog_dashboard");
        yield "\">
      <svg class=\"icon\"><use href=\"#i-home\"></use></svg>
      <span>KPI Catalogue</span>
    </a>
    <a class=\"navItem ";
        // line 59
        yield ((CoreExtension::inFilter((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 59, $this->source); })()), ["admin_products", "admin_product_detail", "admin_product_form"])) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 65
        yield ((CoreExtension::inFilter((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 65, $this->source); })()), ["admin_orders", "admin_order_detail"])) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 69
        yield ((((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 69, $this->source); })()) == "admin_carts")) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 75
        yield ((CoreExtension::inFilter((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 75, $this->source); })()), ["admin_teams", "admin_team_detail"])) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 79
        yield ((CoreExtension::inFilter((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 79, $this->source); })()), ["admin_tournament_requests", "admin_tournament_request_detail"])) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 83
        yield ((CoreExtension::inFilter((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 83, $this->source); })()), ["admin_tournaments", "admin_tournament_detail", "admin_tournament_form", "admin_tournament_create", "admin_tournament_edit"])) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 87
        yield ((CoreExtension::inFilter((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 87, $this->source); })()), ["admin_matches", "admin_match_detail", "admin_match_teams"])) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 93
        yield ((((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 93, $this->source); })()) == "admin_notifications")) ? ("active") : (""));
        yield "\" href=\"";
    ...
    <a class=\"navItem ";
        // line 97
        yield ((((isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 97, $this->source); })()) == "admin_images")) ? ("active") : (""));
        yield "\" href=\"";
...
";
    ...
    {
        return array (  237 => 97,  228 => 93,  217 => 87,  208 => 83,  199 => 79,  190 => 75,  179 => 69,  170 => 65,  159 => 59,  150 => 55,  141 => 51,  132 => 47,  121 => 41,  112 => 37,  103 => 33,  94 => 29,  83 => 23,  74 => 19,  63 => 13,  50 => 2,  48 => 1,);
    }
...
<aside class=\"sidebar\">
  ...
  <nav class=\"sideNav\" aria-label=\"Navigation principale\">
    ...
    <a class=\"navItem {{ currentRoute == 'admin_catalog_dashboard' ? 'active' : '' }}\" href=\"{{ path('admin_catalog_dashboard') }}\">
      <svg class=\"icon\"><use href=\"#i-home\"></use></svg>
      <span>KPI Catalogue</span>
    </a>
