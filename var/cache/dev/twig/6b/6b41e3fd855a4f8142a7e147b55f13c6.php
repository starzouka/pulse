...
class __TwigTemplate_827d049ac47bc7b64923ed45eb9c7848 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "  ";
        yield from $this->load("front/partials/_hero_mini.html.twig", 6)->unwrap()->yield(CoreExtension::merge($context, ["hero_kicker" => "JEUX", "hero_title" => "Catalogue des jeux", "hero_sub" => "Recherche, filtres, score intelligent et tendances.", "breadcrumb_current" => "Catalogue des jeux"]));
        // line 12
        yield "
  <main class=\"page\">
    <section class=\"belowHero\">
      ...
      <section class=\"panel\" style=\"margin-top:14px;\">
        <div class=\"panel__header\" style=\"display:flex;justify-content:space-between;align-items:center;\">
          ...
          <span class=\"listMeta\">Classement par score intelligent</span>
        </div>
        <div class=\"cardsGrid\" style=\"margin-top:10px;\">
          ";
        // line 78
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["trending_games"]) || array_key_exists("trending_games", $context) ? $context["trending_games"] : (function () { throw new RuntimeError('Variable "trending_games" does not exist.', 78, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["game"]) {
            ...
            // line 87
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["game"], "categoryId", [], "any", false, false, false, 87)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["game"], "categoryId", [], "any", false, false, false, 87), "name", [], "any", false, false, false, 87), "html", null, true)) : ("Categorie"));
            yield "</span>
                  <span class=\"chip\">Score: ";
            // line 88
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "popularityScore", [], "any", false, false, false, 88), "html", null, true);
            yield "</span>
                  <span class=\"chip\">Actifs: ";
            // line 89
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["activeCount"]) || array_key_exists("activeCount", $context) ? $context["activeCount"] : (function () { throw new RuntimeError('Variable "activeCount" does not exist.', 89, $this->source); })()), "html", null, true);
            yield "</span>
                </div>
              </div>
            ...
            yield "</h4>
                <div class=\"card__metaRow\">
                  <span class=\"metaPill\">Vues: <b>";
            // line 95
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "viewsCount", [], "any", false, false, false, 95), "html", null, true);
            yield "</b></span>
                  <span class=\"metaPill\">Favoris: <b>";
            // line 96
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "favoritesCount", [], "any", false, false, false, 96), "html", null, true);
            yield "</b></span>
                </div>
                <div class=\"card__actions\">
                  <a class=\"btn btn--primary\" href=\"";
            // line 99
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_game_detail", ["slug" => CoreExtension::getAttribute($this->env, $this->source, $context["game"], "slug", [], "any", false, false, false, 99)]), "html", null, true);
            yield "\">Detail</a>
                </div>
              </div>
            </article>
        ...
        if (!$context['_iterated']) {
            // line 104
            yield "            <div class=\"panel emptyState\" style=\"grid-column:1 / -1;\">Aucun jeu tendance pour le moment.</div>
          ";
        }
        $_parent = $context['_parent'];
      ...
      <section class=\"cardsGrid\" style=\"margin-top:14px;\">
        ";
        // line 110
        if (Twig\Extension\CoreExtension::testEmpty((isset($context["games"]) || array_key_exists("games", $context) ? $context["games"] : (function () { throw new RuntimeError('Variable "games" does not exist.', 110, $this->source); })()))) {
            // line 111
        ...
        ";
            ...
            yield "          ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["games"]) || array_key_exists("games", $context) ? $context["games"] : (function () { throw new RuntimeError('Variable "games" does not exist.', 115, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["game"]) {
                // line 116
                yield "            ";
                $context["gameId"] = (((CoreExtension::getAttribute($this->env, $this->source, $context["game"], "gameId", [], "any", true, true, false, 116) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, $context["game"], "gameId", [], "any", false, false, false, 116)))) ? (CoreExtension::getAttribute($this->env, $this->source, $context["game"], "gameId", [], "any", false, false, false, 116)) : (0));
                // line 117
                yield "            ";
                $context["imagePath"] = (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["game"], "coverImageId", [], "any", false, false, false, 117)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["game"], "coverImageId", [], "any", false, false, false, 117), "fileUrl", [], "any", false, false, false, 117)) : (""));
                // line 118
                yield "            ";
                $context["imageUrl"] = (((($tmp = (isset($context["imagePath"]) || array_key_exists("imagePath", $context) ? $context["imagePath"] : (function () { throw new RuntimeError('Variable "imagePath" does not exist.', 118, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ((((is_string($_v2 = (isset($context["imagePath"]) || array_key_exists("imagePath", $context) ? $context["imagePath"] : (function () { throw new RuntimeError('Variable "imagePath" does not exist.', 118, $this->source); })())) && is_string($_v3 = "http") && str_starts_with($_v2, $_v3))) ? ((isset($context["imagePath"]) || array_key_exists("imagePath", $context) ? $context["imagePath"] : (function () { throw new RuntimeError('Variable "imagePath" does not exist.', 118, $this->source); })())) : ($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((isset($context["imagePath"]) || array_key_exists("imagePath", $context) ? $context["imagePath"] : (function () { throw new RuntimeError('Variable "imagePath" does not exist.', 118, $this->source); })()))))) : ((("https://picsum.photos/seed/pulse_game_" . (isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 118, $this->source); })())) . "/1200/800")));
                // line 119
                yield "            ";
                $context["activeCount"] = ((CoreExtension::getAttribute($this->env, $this->source, ($context["active_tournaments_count_by_game_id"] ?? null), (isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 119, $this->source); })()), [], "array", true, true, false, 119)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["active_tournaments_count_by_game_id"]) || array_key_exists("active_tournaments_count_by_game_id", $context) ? $context["active_tournaments_count_by_game_id"] : (function () { throw new RuntimeError('Variable "active_tournaments_count_by_game_id" does not exist.', 119, $this->source); })()), (isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 119, $this->source); })()), [], "array", false, false, false, 119), 0)) : (0));
                // line 120
                yield "            ";
                $context["totalCount"] = ((CoreExtension::getAttribute($this->env, $this->source, ($context["tournaments_count_by_game_id"] ?? null), (isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 120, $this->source); })()), [], "array", true, true, false, 120)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["tournaments_count_by_game_id"]) || array_key_exists("tournaments_count_by_game_id", $context) ? $context["tournaments_count_by_game_id"] : (function () { throw new RuntimeError('Variable "tournaments_count_by_game_id" does not exist.', 120, $this->source); })()), (isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 120, $this->source); })()), [], "array", false, false, false, 120), 0)) : (0));
                // line 121
                yield "
            <article class=\"card card--game\">
              <div class=\"card__media\" data-bg=\"";
                // line 123
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["imageUrl"]) || array_key_exists("imageUrl", $context) ? $context["imageUrl"] : (function () { throw new RuntimeError('Variable "imageUrl" does not exist.', 123, $this->source); })()), "html", null, true);
                yield "\">
                <div class=\"card__chips\">
                  <span class=\"chip chip--category\">";
                // line 125
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["game"], "categoryId", [], "any", false, false, false, 125)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["game"], "categoryId", [], "any", false, false, false, 125), "name", [], "any", false, false, false, 125), "html", null, true)) : ("Categorie"));
                yield "</span>
                  <span class=\"chip\">";
                // line 126
                yield ((CoreExtension::getAttribute($this->env, $this->source, $context["game"], "publisher", [], "any", false, false, false, 126)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "publisher", [], "any", false, false, false, 126), "html", null, true)) : ("Publisher -"));
                yield "</span>
              ...
              <div class=\"card__body\">
                <h4 class=\"card__title\">";
                // line 131
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "name", [], "any", false, false, false, 131), "html", null, true);
                yield "</h4>
                <p class=\"card__desc\">
                  ";
                // line 133
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["game"], "description", [], "any", false, false, false, 133)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["game"], "description", [], "any", false, false, false, 133), 0, 95) . (((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["game"], "description", [], "any", false, false, false, 133)) > 95)) ? ("...") : (""))), "html", null, true)) : ("Description non disponible."));
                yield "
                </p>
                <div class=\"card__metaRow\">
                  <span class=\"metaPill\">Total tournois: <b>";
                // line 136
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["totalCount"]) || array_key_exists("totalCount", $context) ? $context["totalCount"] : (function () { throw new RuntimeError('Variable "totalCount" does not exist.', 136, $this->source); })()), "html", null, true);
                yield "</b></span>
                  <span class=\"metaPill\">Actifs: <b>";
                // line 137
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["activeCount"]) || array_key_exists("activeCount", $context) ? $context["activeCount"] : (function () { throw new RuntimeError('Variable "activeCount" does not exist.', 137, $this->source); })()), "html", null, true);
                yield "</b></span>
                </div>
                <div class=\"card__metaRow\">
                  <span class=\"metaPill\">Vues: <b>";
                // line 140
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "viewsCount", [], "any", false, false, false, 140), "html", null, true);
                yield "</b></span>
                  <span class=\"metaPill\">Favoris: <b>";
                // line 141
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "favoritesCount", [], "any", false, false, false, 141), "html", null, true);
                yield "</b></span>
                  <span class=\"metaPill\">Score: <b>";
                // line 142
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["game"], "popularityScore", [], "any", false, false, false, 142), "html", null, true);
                yield "</b></span>
                </div>
                <div class=\"card__actions\">
                  <a class=\"btn btn--ghost\" href=\"";
                // line 145
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_game_detail", ["slug" => CoreExtension::getAttribute($this->env, $this->source, $context["game"], "slug", [], "any", false, false, false, 145)]), "html", null, true);
                yield "\">Detail</a>
                  <a class=\"btn btn--primary\" href=\"";
                // line 146
                yield ((((isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 146, $this->source); })()) > 0)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_tournaments", ["game" => (isset($context["gameId"]) || array_key_exists("gameId", $context) ? $context["gameId"] : (function () { throw new RuntimeError('Variable "gameId" does not exist.', 146, $this->source); })())]), "html", null, true)) : ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_tournaments")));
                yield "\">Tournois</a>
                </div>
              </div>
            </article>
      ...
      ";
        // line 154
        yield from $this->load("front/partials/_pagination.html.twig", 154)->unwrap()->yield(CoreExtension::merge($context, ["pagination" =>         // line 155
(isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 155, $this->source); })()), "route_name" => "front_games"]));
        // line 158
        yield "
      ";
        // line 159
        yield from $this->load("front/partials/_footer.html.twig", 159)->unwrap()->yield($context);
        // line 160
        yield "    </section>
  </main>
  ...
  ";
        // line 163
        yield from $this->load("front/partials/_auth_modal.html.twig", 163)->unwrap()->yield($context);
    ...
    {
        return array (  443 => 163,  438 => 160,  436 => 159,  433 => 158,  431 => 155,  430 => 154,  426 => 152,  423 => 151,  412 => 146,  408 => 145,  402 => 142,  398 => 141,  394 => 140,  388 => 137,  384 => 136,  378 => 133,  373 => 131,  366 => 127,  362 => 126,  358 => 125,  353 => 123,  349 => 121,  346 => 120,  343 => 119,  340 => 118,  337 => 117,  334 => 116,  329 => 115,  323 => 111,  321 => 110,  315 => 106,  308 => 104,  306 => 103,  297 => 99,  291 => 96,  287 => 95,  282 => 93,  275 => 89,  271 => 88,  267 => 87,  262 => 85,  258 => 83,  255 => 82,  252 => 81,  249 => 80,  246 => 79,  241 => 78,  228 => 68,  220 => 63,  212 => 58,  208 => 57,  204 => 56,  200 => 55,  196 => 54,  189 => 49,  180 => 46,  173 => 45,  169 => 44,  161 => 38,  152 => 35,  145 => 34,  141 => 33,  133 => 28,  129 => 27,  121 => 22,  117 => 21,  111 => 18,  103 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
  {% include 'front/partials/_hero_mini.html.twig' with {
    ...
    hero_sub: 'Recherche, filtres, score intelligent et tendances.',
      ...
      <section class=\"panel\" style=\"margin-top:14px;\">
        ...
        <div class=\"cardsGrid\" style=\"margin-top:10px;\">
          {% for game in trending_games %}
            ...
            {% set imageUrl = imagePath ? (imagePath starts with 'http' ? imagePath : asset(imagePath)) : 'https://picsum.photos/seed/pulse_game_trending_' ~ gameId ~ '/1200/800' %}
            {% set activeCount = trending_active_tournaments_count_by_game_id[gameId]|default(0) %}

            <article class=\"card card--game\">
              <div class=\"card__media\" data-bg=\"{{ imageUrl }}\">
                <div class=\"card__chips\">
                  <span class=\"chip chip--category\">{{ game.categoryId ? game.categoryId.name : 'Categorie' }}</span>
                  <span class=\"chip\">Score: {{ game.popularityScore }}</span>
                  <span class=\"chip\">Actifs: {{ activeCount }}</span>
                </div>
              </div>
              <div class=\"card__body\">
                <h4 class=\"card__title\">{{ game.name }}</h4>
                <div class=\"card__metaRow\">
                  <span class=\"metaPill\">Vues: <b>{{ game.viewsCount }}</b></span>
                  <span class=\"metaPill\">Favoris: <b>{{ game.favoritesCount }}</b></span>
                </div>
                <div class=\"card__actions\">
                  <a class=\"btn btn--primary\" href=\"{{ path('front_game_detail', {slug: game.slug}) }}\">Detail</a>
                </div>
              </div>
            </article>
          {% else %}
            <div class=\"panel emptyState\" style=\"grid-column:1 / -1;\">Aucun jeu tendance pour le moment.</div>
          {% endfor %}
        </div>
      </section>
            ...
            <article class=\"card card--game\">
              ...
              <div class=\"card__body\">
                ...
                <div class=\"card__metaRow\">
                  <span class=\"metaPill\">Vues: <b>{{ game.viewsCount }}</b></span>
                  <span class=\"metaPill\">Favoris: <b>{{ game.favoritesCount }}</b></span>
                  <span class=\"metaPill\">Score: <b>{{ game.popularityScore }}</b></span>
                </div>
                <div class=\"card__actions\">
                  <a class=\"btn btn--ghost\" href=\"{{ path('front_game_detail', {slug: game.slug}) }}\">Detail</a>
