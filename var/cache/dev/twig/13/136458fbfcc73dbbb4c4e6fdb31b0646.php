...
class __TwigTemplate_1751bd134694c0963d0464d5b58cb5be extends Template
{
  ...
  ";
        // line 8
        yield from $this->load("front/partials/_hero_mini.html.twig", 8)->unwrap()->yield(CoreExtension::merge($context, ["hero_kicker" => "TOURNOI", "hero_title" => "Détail tournoi", "hero_sub" => "Progression, scores, matchs et équipes.", "breadcrumb_current" => "Détail tournoi"]));
        // line 14
        yield "
  ...
  <main class=\"page\">
    ...
    <article class=\"card card--team\">
      ...
      ";
        // line 252
        yield from $this->load("front/partials/_footer.html.twig", 252)->unwrap()->yield($context);
        // line 253
        yield "
    </section>
  </main>
  ...
  ";
        // line 257
        yield from $this->load("front/partials/_auth_modal.html.twig", 257)->unwrap()->yield($context);
        // line 258
        yield "
";
    ...
    {
        return array (  380 => 258,  378 => 257,  372 => 253,  370 => 252,  342 => 227,  315 => 203,  288 => 179,  261 => 155,  230 => 127,  206 => 106,  182 => 85,  132 => 38,  106 => 14,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
", "front/pages/tournament-detail.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE\\PULSE\\templates\\front\\pages\\tournament-detail.html.twig");
    }
}
