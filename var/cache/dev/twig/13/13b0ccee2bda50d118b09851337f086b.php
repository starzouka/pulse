...
class __TwigTemplate_ca41e03716c7ce9a7bea60fc17e306fe extends Template
{
      ...
      <section class=\"cardsGrid\">
        ...
        {% else %}
          {% for game in games %}
            ...
            {% set imageUrl = imagePath ? (imagePath starts with 'http' ? imagePath : (asset(imagePath)|imagine_filter('game_cover_card'))) : 'https://picsum.photos/seed/pulse_game_' ~ gameId ~ '/1200/800' %}
...
{% endblock %}
", "front/pages/games.html.twig", "C:\\Users\\MiaMaria\\Desktop\\pulse\\pulse\\templates\\front\\pages\\games.html.twig");
    }
}
