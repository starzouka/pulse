...
class __TwigTemplate_e2edf46219156d87e59ba42e015f9927 extends Template
{
    ...
    <section class=\"belowHero\">
      <div class=\"layout\">
        ...
        yield "
              ";
        // line 30
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["matchForm"]) || array_key_exists("matchForm", $context) ? $context["matchForm"] : (function () { throw new RuntimeError('Variable "matchForm" does not exist.', 30, $this->source); })()), 'errors');
        yield "
              ";
        // line 31
        yield from $this->load("shared/_organizer_match_form_fields.html.twig", 31)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["matchForm"]) || array_key_exists("matchForm", $context) ? $context["matchForm"] : (function () { throw new RuntimeError('Variable "matchForm" does not exist.', 31, $this->source); })())]));
        // line 32
        yield "              <div class=\"formActions\" style=\"margin-top:12px;\">
                <button class=\"btn btn--primary\" type=\"submit\">Creer match</button>
                <a class=\"btn btn--ghost\" href=\"";
        // line 34
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("front_organizer_matches", (((($tmp = (isset($context["selectedTournament"]) || array_key_exists("selectedTournament", $context) ? $context["selectedTournament"] : (function () { throw new RuntimeError('Variable "selectedTournament" does not exist.', 34, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (["tournament" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["selectedTournament"]) || array_key_exists("selectedTournament", $context) ? $context["selectedTournament"] : (function () { throw new RuntimeError('Variable "selectedTournament" does not exist.', 34, $this->source); })()), "tournamentId", [], "any", false, false, false, 34)]) : ([]))), "html", null, true);
        yield "\">Annuler</a>
              </div>
            ";
        // line 36
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["matchForm"]) || array_key_exists("matchForm", $context) ? $context["matchForm"] : (function () { throw new RuntimeError('Variable "matchForm" does not exist.', 36, $this->source); })()), 'form_end');
        yield "
          </section>
  ...
  ";
        // line 68
        yield from $this->load("front/partials/_auth_modal.html.twig", 68)->unwrap()->yield($context);
    ...
    {
        return array (  209 => 68,  204 => 65,  202 => 64,  171 => 36,  166 => 34,  162 => 32,  160 => 31,  156 => 30,  152 => 29,  148 => 27,  142 => 26,  131 => 23,  127 => 22,  124 => 21,  119 => 20,  115 => 19,  111 => 17,  109 => 16,  103 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "front/pages/organizer-match-create.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE - Copie\\PULSE\\templates\\front\\pages\\organizer-match-create.html.twig");
    }
}
