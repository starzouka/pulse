...
class __TwigTemplate_b96fad37830fb9df81123893f4d8faf4 extends Template
{
  ...
  <section class=\"panel\">
    ...
    ";
      ...
      ";
        // line 31
        yield from $this->load("admin/pages/_report_form_fields.html.twig", 31)->unwrap()->yield(CoreExtension::merge($context, ["form" => (isset($context["reportForm"]) || array_key_exists("reportForm", $context) ? $context["reportForm"] : (function () { throw new RuntimeError('Variable "reportForm" does not exist.', 31, $this->source); })())]));
        // line 32
    ...
    ";
        // line 35
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["reportForm"]) || array_key_exists("reportForm", $context) ? $context["reportForm"] : (function () { throw new RuntimeError('Variable "reportForm" does not exist.', 35, $this->source); })()), 'form_end');
        yield "
  </section>
  ...
  <section class=\"panel\">
    ...
    <div class=\"list\">
      <div class=\"listItem\"><span>target_type</span><span class=\"listMeta\">";
        // line 44
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["targetType"]) || array_key_exists("targetType", $context) ? $context["targetType"] : (function () { throw new RuntimeError('Variable "targetType" does not exist.', 44, $this->source); })()), "html", null, true);
        yield "</span></div>
      <div class=\"listItem\"><span>target_id</span><span class=\"listMeta\">";
        // line 45
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["report"]) || array_key_exists("report", $context) ? $context["report"] : (function () { throw new RuntimeError('Variable "report" does not exist.', 45, $this->source); })()), "targetId", [], "any", false, false, false, 45), "html", null, true);
        yield "</span></div>

      ";
        // line 47
        if ((($tmp = (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 47, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 48
            yield "        ";
            if (((isset($context["targetType"]) || array_key_exists("targetType", $context) ? $context["targetType"] : (function () { throw new RuntimeError('Variable "targetType" does not exist.', 48, $this->source); })()) == "POST")) {
                // line 49
                yield "          <div class=\"listItem\"><span>Post</span><span class=\"listMeta\">";
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 49, $this->source); })()), "contentText", [], "any", false, false, false, 49)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 49, $this->source); })()), "contentText", [], "any", false, false, false, 49), 0, 100), "html", null, true)) : ("-"));
                yield "</span></div>
          <div class=\"listItem\"><span>Action</span><span class=\"listMeta\"><a class=\"btn btnTiny\" href=\"";
                // line 50
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_post_detail", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 50, $this->source); })()), "postId", [], "any", false, false, false, 50)]), "html", null, true);
                yield "\">Voir post</a></span></div>
        ";
            } elseif ((            // line 51
(isset($context["targetType"]) || array_key_exists("targetType", $context) ? $context["targetType"] : (function () { throw new RuntimeError('Variable "targetType" does not exist.', 51, $this->source); })()) == "COMMENT")) {
                // line 52
                yield "          <div class=\"listItem\"><span>Commentaire</span><span class=\"listMeta\">";
                yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 52, $this->source); })()), "contentText", [], "any", false, false, false, 52)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 52, $this->source); })()), "contentText", [], "any", false, false, false, 52), 0, 100), "html", null, true)) : ("-"));
                yield "</span></div>
          <div class=\"listItem\"><span>Action</span><span class=\"listMeta\"><a class=\"btn btnTiny\" href=\"";
                // line 53
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_comments", ["edit" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 53, $this->source); })()), "commentId", [], "any", false, false, false, 53)]), "html", null, true);
                yield "\">Voir commentaire</a></span></div>
        ";
            } elseif ((            // line 54
(isset($context["targetType"]) || array_key_exists("targetType", $context) ? $context["targetType"] : (function () { throw new RuntimeError('Variable "targetType" does not exist.', 54, $this->source); })()) == "USER")) {
                // line 55
                yield "          <div class=\"listItem\"><span>User</span><span class=\"listMeta\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 55, $this->source); })()), "username", [], "any", false, false, false, 55), "html", null, true);
                yield " (";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 55, $this->source); })()), "email", [], "any", false, false, false, 55), "html", null, true);
                yield ")</span></div>
          <div class=\"listItem\"><span>Action</span><span class=\"listMeta\"><a class=\"btn btnTiny\" href=\"";
                // line 56
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_user_detail", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 56, $this->source); })()), "userId", [], "any", false, false, false, 56)]), "html", null, true);
                yield "\">Voir utilisateur</a></span></div>
        ";
            } elseif ((            // line 57
(isset($context["targetType"]) || array_key_exists("targetType", $context) ? $context["targetType"] : (function () { throw new RuntimeError('Variable "targetType" does not exist.', 57, $this->source); })()) == "TEAM")) {
                // line 58
                yield "          <div class=\"listItem\"><span>Team</span><span class=\"listMeta\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 58, $this->source); })()), "name", [], "any", false, false, false, 58), "html", null, true);
                yield "</span></div>
          <div class=\"listItem\"><span>Action</span><span class=\"listMeta\"><a class=\"btn btnTiny\" href=\"";
                // line 59
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_team_detail", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["targetEntity"]) || array_key_exists("targetEntity", $context) ? $context["targetEntity"] : (function () { throw new RuntimeError('Variable "targetEntity" does not exist.', 59, $this->source); })()), "teamId", [], "any", false, false, false, 59)]), "html", null, true);
...
";
    ...
    {
        return array (  248 => 64,  244 => 62,  241 => 61,  236 => 59,  231 => 58,  229 => 57,  225 => 56,  218 => 55,  216 => 54,  212 => 53,  207 => 52,  205 => 51,  201 => 50,  196 => 49,  193 => 48,  191 => 47,  186 => 45,  182 => 44,  170 => 35,  165 => 32,  163 => 31,  159 => 30,  151 => 24,  145 => 23,  134 => 20,  130 => 19,  127 => 18,  122 => 17,  118 => 16,  111 => 12,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}", "admin/pages/report-detail.html.twig", "C:\\Users\\ilyes\\OneDrive\\Bureau\\PULSE\\PULSE\\templates\\admin\\pages\\report-detail.html.twig");
    }
}
