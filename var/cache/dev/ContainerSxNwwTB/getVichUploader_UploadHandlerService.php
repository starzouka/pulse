...
class getVichUploader_UploadHandlerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Vich\UploaderBundle\Handler\UploadHandler(($container->privates['vich_uploader.property_mapping_factory'] ?? $container->load('getVichUploader_PropertyMappingFactoryService')), $b, new \Vich\UploaderBundle\Injector\FileInjector($b), $a);

        if (isset($container->services['vich_uploader.upload_handler'])) {
            return $container->services['vich_uploader.upload_handler'];
        }

        return $container->services['vich_uploader.upload_handler'] = $instance;
    }
}
