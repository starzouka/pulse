...
class getTurbo_Twig_RuntimeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\Turbo\Twig\TurboRuntime(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        if (isset($container->privates['turbo.twig.runtime'])) {
            return $container->privates['turbo.twig.runtime'];
        }

        return $container->privates['turbo.twig.runtime'] = $instance;
    }
}
