 ...
 */
class getVichUploader_Listener_Clean_GameCoverService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.game_cover' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.game_cover'])) {
            return $container->privates['vich_uploader.listener.clean.game_cover'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('game_cover', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.clean.game_cover'])) {
            return $container->privates['vich_uploader.listener.clean.game_cover'];
        }

        return $container->privates['vich_uploader.listener.clean.game_cover'] = $instance;
    }
}
