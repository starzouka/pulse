 ...
 */
final class Version20260224213113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tournament_requests (request_id INT UNSIGNED AUTO_INCREMENT NOT NULL, title VARCHAR(180) NOT NULL, description LONGTEXT DEFAULT NULL, rules LONGTEXT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, registration_deadline DATE DEFAULT NULL, max_teams INT UNSIGNED NOT NULL, format VARCHAR(3) DEFAULT \'BO1\' NOT NULL, registration_mode VARCHAR(8) DEFAULT \'OPEN\' NOT NULL, prize_pool NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, prize_description VARCHAR(255) DEFAULT NULL, status VARCHAR(8) DEFAULT \'PENDING\' NOT NULL, photo_path VARCHAR(255) DEFAULT NULL, admin_response_note LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, reviewed_at DATETIME DEFAULT NULL, organizer_user_id INT UNSIGNED NOT NULL, game_id INT UNSIGNED NOT NULL, reviewed_by_admin_id INT UNSIGNED DEFAULT NULL, INDEX IDX_9B3B30B4EE5F645C (organizer_user_id), INDEX IDX_9B3B30B4E48FD905 (game_id), INDEX IDX_9B3B30B472001902 (reviewed_by_admin_id), PRIMARY KEY (request_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE tournaments (tournament_id INT UNSIGNED AUTO_INCREMENT NOT NULL, title VARCHAR(180) NOT NULL, description LONGTEXT DEFAULT NULL, rules LONGTEXT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, registration_deadline DATE DEFAULT NULL, max_teams INT UNSIGNED NOT NULL, format VARCHAR(3) DEFAULT \'BO1\' NOT NULL, registration_mode VARCHAR(8) DEFAULT \'OPEN\' NOT NULL, prize_pool NUMERIC(12, 2) DEFAULT \'0.00\' NOT NULL, prize_description VARCHAR(255) DEFAULT NULL, status VARCHAR(9) DEFAULT \'DRAFT\' NOT NULL, photo_path VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, organizer_user_id INT UNSIGNED NOT NULL, game_id INT UNSIGNED NOT NULL, INDEX IDX_E4BCFAC3EE5F645C (organizer_user_id), INDEX IDX_E4BCFAC3E48FD905 (game_id), PRIMARY KEY (tournament_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE users (user_id INT UNSIGNED AUTO_INCREMENT NOT NULL, username VARCHAR(50) NOT NULL, email VARCHAR(190) NOT NULL, password_hash VARCHAR(255) NOT NULL, role VARCHAR(9) DEFAULT \'PLAYER\' NOT NULL, display_name VARCHAR(80) NOT NULL, bio LONGTEXT DEFAULT NULL, phone VARCHAR(30) DEFAULT NULL, country VARCHAR(80) DEFAULT NULL, birth_date DATE DEFAULT NULL, gender VARCHAR(7) DEFAULT \'UNKNOWN\', email_verified TINYINT DEFAULT 0 NOT NULL, is_active TINYINT DEFAULT 1 NOT NULL, last_login_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, reset_password_token_hash VARCHAR(64) DEFAULT NULL, reset_password_expires_at DATETIME DEFAULT NULL, profile_image_id INT UNSIGNED DEFAULT NULL, INDEX IDX_1483A5E9C4CF44DC (profile_image_id), PRIMARY KEY (user_id)) DEFAULT CHARACTER SET utf8mb4');
